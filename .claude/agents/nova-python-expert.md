...
2. **`Decimal` for money + nutrition math.** Float arithmetic forbidden in: kcal, macros, weight, money. Use `Decimal` + `ROUND_HALF_EVEN` (banker's rounding, IEEE 754-2008 default).
