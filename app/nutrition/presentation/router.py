...
def _to_resp(g: NutritionalGoals) -> GoalsResponse:
    return GoalsResponse(
        id=g.id, kcal_min=g.kcal_min, kcal_max=g.kcal_max,
        protein_g=g.protein_g, carbs_g=g.carbs_g, fat_g=g.fat_g,
        water_ml=g.water_ml, bmr=g.bmr, tdee=g.tdee,
        activity_factor=g.activity_factor, reason=g.reason,
