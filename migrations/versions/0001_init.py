...
CONDITION_SYNONYMS: list[tuple[str, str, str]] = [
    ...
    ("dm1", "diabetes_t1", "clinical abbreviation"),
    ("dm2", "diabetes_t2", "clinical abbreviation"),
    ("htn", "hypertension", "clinical abbreviation"),
    ...
    ("renal_failure", "ckd", "clinical variant"),
    ("nafld", "fatty_liver", "clinical abbreviation"),
    ("non_alcoholic_fatty_liver", "fatty_liver", "expanded form"),
    ("hepatic_steatosis", "fatty_liver", "clinical synonym"),
    ...
    ("ferropenic_anemia", "iron_deficiency_anemia", "clinical variant"),
