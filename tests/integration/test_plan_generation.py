...
@pytest.mark.skip(
    reason=(
        "PLACEHOLDER: scaffolding only. The real test needs the live "
        "PlanGenerationOrchestrator wired to the testcontainer repository "
        "and SqlPlanRepository.save(). Tracked under D-plan-integ. "
        "Stubs above pin the Layer1-4 contracts the real test must honour."
    )
)
