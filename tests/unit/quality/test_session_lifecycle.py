...
ALLOWED_SESSION_SCOPE: dict[str, str] = {
    ...
    "worker/coach_tasks.py:55": "OK3 worker task",
    "worker/coach_tasks.py:69": "OK3 worker task",
    "worker/coach_tasks.py:89": "OK3 worker task",
    "worker/coach_tasks.py:103": "OK3 worker task",
    "worker/coach_tasks.py:109": "OK3 worker task",
    "worker/coach_tasks.py:115": "OK3 worker task",
}
